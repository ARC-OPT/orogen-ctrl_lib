# Contributing to orogen-ctrl_lib
...
1. Fork the [project repository](https://github.com/ARC-OPT/orogen-ctrl_lib):
   click on the 'Fork' button near the top of the page. This creates a copy of
   the code under your account on the Gitlab server.

3. Clone this copy to your local disk:

        $ git clone git@github.com:YourLogin/orogen-ctrl_lib.git
...
* See [issues](https://github.com/ARC-OPT/wbc/issues) of the wbc library
